...
import com.intel.ssg.dcst.panthera.parse.ql.PantheraHiveParser_SelectClauseParser;
...
public class HiveParseDriver {
   ...
   *
   */
  public class HiveLexerX extends PantheraHiveLexer {
  ...
  public ASTNode parse(String command, Context ctx) throws ParseException {
    ...
    PantheraHiveParser parser = new PantheraHiveParser(tokens);
    parser.setTreeAdaptor(adaptor);
    PantheraHiveParser.statement_return r = null;
    try {
      r = parser.statement();
  ...
  public ASTNode parseSelect(String command, Context ctx) throws ParseException {
    ...
    PantheraHiveParser parser = new PantheraHiveParser(tokens);
    parser.setTreeAdaptor(adaptor);
    PantheraHiveParser_SelectClauseParser.selectClause_return r = null;
    try {
