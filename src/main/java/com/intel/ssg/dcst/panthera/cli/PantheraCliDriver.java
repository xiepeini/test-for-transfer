...
import com.intel.ssg.dcst.panthera.ql.SkinDriver;
import com.intel.ssg.dcst.panthera.processor.PantheraProcessorFactory;
    ...
    try {
      ...
      for (String oneCmd : line.split(";")) {
        ...
        if (ret != 0 && !ignoreErrors) {
          PantheraProcessorFactory.clean((HiveConf) conf);
          return ret;
        }
      }
      PantheraProcessorFactory.clean((HiveConf) conf);
