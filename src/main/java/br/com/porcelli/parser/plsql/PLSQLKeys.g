...
sort_key
    :    {input.LT(1).getText().equalsIgnoreCase("sort")}?=> REGULAR_ID -> SORT_VK[$REGULAR_ID]
    ;

distribute_key
    :    {input.LT(1).getText().equalsIgnoreCase("distribute")}?=> REGULAR_ID -> DISTRIBUTE_VK[$REGULAR_ID]
    ;
...
substring_key
    :    {input.LT(1).getText().equalsIgnoreCase("substring")}? REGULAR_ID -> SUBSTRING_VK[$REGULAR_ID]
    ;
